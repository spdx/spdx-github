...
#using the web page, but not the API below.
r = requests.post('https://github.com/abuhman/test_webhooks/hooks', data = '{"name":"web","active": true,"events": ["pull_request"],"config": {"url": "http://abuhmans.localhost/","content_type":"json"}}', auth=('abuhman', 'abuhmanspassword'))
