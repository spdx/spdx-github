...
These instructions were made on Ubuntu 14.04.  These instructions assume that Python has already been installed.
...
The above should get a local instance working.  Further installation instructions if the user would like to use webhooks:
